...
for instruction in instructions:
    ...
    # * The change for part the is not reversing the order of the crates
    # get the last [amount] crates from the source stack
    moved_crates = stack_data[source_stack_number][-amount:]
